...
import com.geek.newunion.di.component.DaggerOrderFragmentComponent;
...
import com.geek.newunion.mvp.presenter.OrderFragmentPresenter;
...
public class OrderFragment extends BaseFragment<OrderFragmentPresenter> implements OrderFragmentContract.View {
    ...
    public void setupFragmentComponent(AppComponent appComponent) {
        DaggerOrderFragmentComponent //如找不到该类,请编译一下项目
                .builder()
